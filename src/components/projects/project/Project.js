  ...
  return (
    <div className="cc__project-container">
      <div className="cc__project-img-container">
        <div
          className="cc__project-img-container-overlay"
          onClick={props.popupShowFunction}
        ></div>
        <img
          src={props.imgUrl}
          alt="a screenshot of one project"
        ></img>
      </div>
      <div className="cc__project-info">
        <p
          className="cc__project-title"
          onClick={props.popupShowFunction}
        >
          {props.projectName}
        </p>
      ...
      <div className="cc__project-nav">
        <div className="cc__project-dpad" id="dpad">
          <div
            className="cc__project-dpad-button d-pad-left"
            onClick={onLeftClick}
          ></div>
          <div
            className="cc__project-dpad-button d-pad-right"
        ...
        <div className="cc__project-buttons">
          <div className="cc__projects-git">
            <a
              className="cc__projects-git-link"
              href={props.gitUrl}
              target="_blank"
              rel="noreferrer"
            >
          ...
          <div className="cc__projects-web">
            <a
              className="cc__projects-web-link"
              href={props.webUrl}
              target="_blank"
              rel="noreferrer"
            >
              <Tippy content="View live website">
      ...
      <Popup
        trigger={props.popupState}
        webUrl={props.webUrl}
        gitUrl={props.gitUrl}
        closeFunction={props.popupCloseFunction}
